Это многопользовательская игра "Змейка". Игроки могут использовать стрелки на одном ноутбуке, чтобы контролировать движение змейки, отображаемой на другом устройстве в реальном времени.
